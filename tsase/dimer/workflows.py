...
from tsase.neb.models.field import EnthalpyWrapper, resolve_field_config, resolve_field_vector
...
class DimerConfig:
    ...
    def from_mapping(cls, mapping, *, source_path=None):
        ...
        field_vector = resolve_field_config(structure.get_cell(), model_config.get("field"))
        ...
        charge_map = (
            None
            if calculator_mode == "mace_field"
            else _resolve_charge_map(model_config.get("charges"))
        )
        ...
        resolved_config = {
            ...
            "model": {
                ...
                **({} if charge_map is None else {"charges": model_config.get("charges")}),

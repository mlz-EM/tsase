...
from tsase.neb.models.field import resolve_field_config, resolve_field_vector
...
class FieldSSNEBConfig:
    ...
    def from_inputs(
        ...
        *,
        ...
        if charge_map is not None:
            resolved_model["charges"] = _serialize_charge_map(charge_map)
    ...
    def from_mapping(cls, mapping, *, source_path=None):
        ...
        field_vector = resolve_field_config(
            structures[0].get_cell(),
        ...
        if calculator_mode.requires_reference_polarization:
            ...
            dict(mapping),
            {
                ...
                "model": {
                    ...
                    **(
                        ...
                        else {"charges": _serialize_charge_map(charge_map)}
                    ),
                    "field": {
